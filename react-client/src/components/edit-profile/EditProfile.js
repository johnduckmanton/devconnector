...
class EditProfile extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.profile.profile) {
      ...
      // Transform skills back to a csv list
      ...
      profile.socialMedia = !isEmpty(profile.socialMedia)
        ? profile.socialMedia
        : {};
      ...
      profile.facebook = !isEmpty(profile.socialMedia.facebook)
        ...
        : '';
      profile.linkedin = !isEmpty(profile.socialMedia.linkedin)
        ? profile.socialMedia.linkedin
        : '';
      profile.youtube = !isEmpty(profile.socialMedia.youtube)
      ...
      if (!isEmpty(profile.socialMedia)) {
